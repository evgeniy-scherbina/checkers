...
export interface CheckersoddnumStoredGame {
  index?: string;
  board?: string;
  turn?: string;
  black?: string;
...
export type OddnumMsgTransferResponse = object;
...
export interface OddnumQueryGetStoredGameResponse {
  storedGame?: CheckersoddnumStoredGame;
}
 ...
 */
export interface OddnumQueryParamsResponse {
  /** params holds all the parameters of this module. */
  params?: CheckersoddnumParams;
}
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @request GET:/alice/checkers/oddnum/params
   */
   ...
   * @request GET:/alice/checkers/oddnum/stored_game
   */
  queryStoredGameAll = (
    query?: {
    ...
    this.request<OddnumQueryAllStoredGameResponse, RpcStatus>({
      path: `/alice/checkers/oddnum/stored_game`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @request GET:/alice/checkers/oddnum/stored_game/{index}
   */
  queryStoredGame = (index: string, params: RequestParams = {}) =>
    this.request<OddnumQueryGetStoredGameResponse, RpcStatus>({
      path: `/alice/checkers/oddnum/stored_game/${index}`,
      method: "GET",
      format: "json",
      ...params,
    });
