...
import { Params } from "../lessernum/params";
import { SystemInfo } from "../lessernum/system_info";
import { StoredGame } from "../lessernum/stored_game";
import {
  PageRequest,
  PageResponse,
...
export class QueryClientImpl implements Query {
  ...
  Params(request: QueryParamsRequest): Promise<QueryParamsResponse> {
    ...
    const promise = this.rpc.request(
      "alice.checkers.lessernum.Query",
      "Params",
      data
    );
