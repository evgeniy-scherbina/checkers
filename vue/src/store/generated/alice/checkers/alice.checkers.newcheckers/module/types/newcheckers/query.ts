...
import { Params } from "../newcheckers/params";
import { SystemInfo } from "../newcheckers/system_info";
import { StoredGame } from "../newcheckers/stored_game";
import {
  PageRequest,
  PageResponse,
} from "../cosmos/base/query/v1beta1/pagination";

export const protobufPackage = "alice.checkers.newcheckers";
...
export class QueryClientImpl implements Query {
  ...
  Params(request: QueryParamsRequest): Promise<QueryParamsResponse> {
    ...
    const promise = this.rpc.request(
      "alice.checkers.newcheckers.Query",
      "Params",
      data
    );
