...
import (
	...
	biggernumsimulation "github.com/alice/checkers/x/biggernum/simulation"
...
var (
	_ = sample.AccAddress
	_ = biggernumsimulation.FindAccount
...
func (AppModule) GenerateGenesisState(simState *module.SimulationState) {
	...
	biggernumGenesis := types.GenesisState{
		Params: types.DefaultParams(),
		// this line is used by starport scaffolding # simapp/module/genesisState
	}
	simState.GenState[types.ModuleName] = simState.Cdc.MustMarshalJSON(&biggernumGenesis)
}
...
func (am AppModule) WeightedOperations(simState module.SimulationState) []simtypes.WeightedOperation {
	...
	operations = append(operations, simulation.NewWeightedOperation(
		weightMsgCreateGame,
		biggernumsimulation.SimulateMsgCreateGame(am.accountKeeper, am.bankKeeper, am.keeper),
	))
	...
	operations = append(operations, simulation.NewWeightedOperation(
		weightMsgPlayMove,
		biggernumsimulation.SimulateMsgPlayMove(am.accountKeeper, am.bankKeeper, am.keeper),
	))
