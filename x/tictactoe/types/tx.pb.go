...
type MsgCreateGame struct {
	...
	XPlayer string `protobuf:"bytes,2,opt,name=xPlayer,proto3" json:"xPlayer,omitempty"`
	OPlayer string `protobuf:"bytes,3,opt,name=oPlayer,proto3" json:"oPlayer,omitempty"`
}
...
func init() {
	proto.RegisterType((*MsgCreateGame)(nil), "alice.checkers.tictactoe.MsgCreateGame")
	proto.RegisterType((*MsgCreateGameResponse)(nil), "alice.checkers.tictactoe.MsgCreateGameResponse")
}
...
var fileDescriptor_82e04dc317c099c4 = []byte{
	...
	,
}
...
func (c *msgClient) CreateGame(ctx context.Context, in *MsgCreateGame, opts ...grpc.CallOption) (*MsgCreateGameResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/alice.checkers.tictactoe.Msg/CreateGame", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_CreateGame_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/alice.checkers.tictactoe.Msg/CreateGame",
	}
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "alice.checkers.tictactoe.Msg",
...
func (m *MsgCreateGame) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.OPlayer) > 0 {
		...
		i = encodeVarintTx(dAtA, i, uint64(len(m.OPlayer)))
		i--
		dAtA[i] = 0x1a
	}
	if len(m.XPlayer) > 0 {
		...
		i = encodeVarintTx(dAtA, i, uint64(len(m.XPlayer)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.Creator) > 0 {
