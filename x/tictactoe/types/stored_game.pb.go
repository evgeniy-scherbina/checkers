...
type StoredGame struct {
	...
	OPlayer  string `protobuf:"bytes,5,opt,name=oPlayer,proto3" json:"oPlayer,omitempty"`
}
...
func (m *StoredGame) GetOPlayer() string {
	if m != nil {
		return m.OPlayer
	}
	return ""
...
var fileDescriptor_890ea4c29805d5e1 = []byte{
	...
	0x16, 0x49, 0xb0, 0x80, 0xa5, 0x60, 0x5c, 0x90, 0x4c, 0x3e, 0x54, 0x86, 0x15, 0x22, 0x03, 0xe5,
	...
	0x00, 0xff, 0xff, 0xfb, 0x00, 0x43, 0x27, 0x11, 0x01, 0x00, 0x00,
}
...
func (m *StoredGame) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.OPlayer) > 0 {
		...
		i = encodeVarintStoredGame(dAtA, i, uint64(len(m.OPlayer)))
		i--
		dAtA[i] = 0x2a
	}
	if len(m.XPlayer) > 0 {
