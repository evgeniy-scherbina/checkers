...
func (m *StoredGame) GetGameId() string {
	if m != nil {
		return m.GameId
	}
	return ""
...
var fileDescriptor_ba9fe6ef1253ec15 = []byte{
	...
	0xce, 0x48, 0x4d, 0xce, 0x4e, 0x2d, 0x2a, 0xd6, 0x83, 0xab, 0x55, 0xca, 0xe3, 0xe2, 0x0a, 0x06,
	0x2b, 0x77, 0x4f, 0xcc, 0x4d, 0x15, 0x12, 0xe1, 0x62, 0xcd, 0xcc, 0x4b, 0x49, 0xad, 0x90, 0x60,
	0x54, 0x60, 0xd4, 0xe0, 0x0c, 0x82, 0x70, 0x84, 0xc4, 0xb8, 0xd8, 0x40, 0x66, 0x79, 0xa6, 0x48,
	0x30, 0x81, 0x85, 0xa1, 0x3c, 0x21, 0x09, 0x2e, 0xf6, 0x82, 0x9c, 0xc4, 0xca, 0xd4, 0x22, 0x43,
	0x09, 0x66, 0xb0, 0x04, 0x8c, 0x8b, 0x90, 0x31, 0x92, 0x60, 0x41, 0x96, 0x31, 0x72, 0x72, 0x3d,
	...
	0x24, 0xbd, 0xe4, 0xfc, 0x5c, 0x7d, 0xb0, 0x73, 0xf5, 0x61, 0xce, 0xd5, 0xaf, 0xd0, 0x47, 0x78,
	0xae, 0xa4, 0xb2, 0x20, 0xb5, 0x38, 0x89, 0x0d, 0xec, 0x2f, 0x63, 0x40, 0x00, 0x00, 0x00, 0xff,
	0xff, 0xce, 0x4e, 0xfc, 0xaf, 0xf6, 0x00, 0x00, 0x00,
}
...
func (m *StoredGame) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.GameId) > 0 {
		...
		i = encodeVarintStoredGame(dAtA, i, uint64(len(m.GameId)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.Index) > 0 {
