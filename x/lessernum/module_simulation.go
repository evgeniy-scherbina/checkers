...
import (
	...
	lessernumsimulation "github.com/alice/checkers/x/lessernum/simulation"
...
var (
	_ = sample.AccAddress
	_ = lessernumsimulation.FindAccount
...
func (AppModule) GenerateGenesisState(simState *module.SimulationState) {
	...
	lessernumGenesis := types.GenesisState{
		Params: types.DefaultParams(),
		// this line is used by starport scaffolding # simapp/module/genesisState
	}
	simState.GenState[types.ModuleName] = simState.Cdc.MustMarshalJSON(&lessernumGenesis)
}
...
func (am AppModule) WeightedOperations(simState module.SimulationState) []simtypes.WeightedOperation {
	...
	operations = append(operations, simulation.NewWeightedOperation(
		weightMsgCreateGame,
		lessernumsimulation.SimulateMsgCreateGame(am.accountKeeper, am.bankKeeper, am.keeper),
	))
	...
	operations = append(operations, simulation.NewWeightedOperation(
		weightMsgPlayMove,
		lessernumsimulation.SimulateMsgPlayMove(am.accountKeeper, am.bankKeeper, am.keeper),
	))
