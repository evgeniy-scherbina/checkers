...
import (
	...
	lessernummodule "github.com/alice/checkers/x/lessernum"
	lessernummodulekeeper "github.com/alice/checkers/x/lessernum/keeper"
	lessernummoduletypes "github.com/alice/checkers/x/lessernum/types"
	monobankmodule "github.com/alice/checkers/x/monobank"
	monobankmodulekeeper "github.com/alice/checkers/x/monobank/keeper"
	monobankmoduletypes "github.com/alice/checkers/x/monobank/types"
	newcheckersmodule "github.com/alice/checkers/x/newcheckers"
	newcheckersmodulekeeper "github.com/alice/checkers/x/newcheckers/keeper"
	newcheckersmoduletypes "github.com/alice/checkers/x/newcheckers/types"
	...
	tictactoemodule "github.com/alice/checkers/x/tictactoe"
	tictactoemodulekeeper "github.com/alice/checkers/x/tictactoe/keeper"
	tictactoemoduletypes "github.com/alice/checkers/x/tictactoe/types"
...
var (
	...
	ModuleBasics = module.NewBasicManager(
		...
		newcheckersmodule.AppModuleBasic{},
...
type App struct {
	*baseapp.BaseApp
	...
	LessernumKeeper lessernummodulekeeper.Keeper

	SumKeeper summodulekeeper.Keeper

	OddnumKeeper oddnummodulekeeper.Keeper

	NewcheckersKeeper newcheckersmodulekeeper.Keeper
...
func NewApp(
	...
	keys := sdk.NewKVStoreKeys(
		...
		newcheckersmoduletypes.StoreKey,
	...
	app.LessernumKeeper = *lessernummodulekeeper.NewKeeper(
		app.BankKeeper,
		appCodec,
		keys[lessernummoduletypes.StoreKey],
		keys[lessernummoduletypes.MemStoreKey],
		app.GetSubspace(lessernummoduletypes.ModuleName),
	)
	lessernumModule := lessernummodule.NewAppModule(appCodec, app.LessernumKeeper, app.AccountKeeper, app.BankKeeper)

	app.SumKeeper = *summodulekeeper.NewKeeper(
		appCodec,
		keys[summoduletypes.StoreKey],
		keys[summoduletypes.MemStoreKey],
		app.GetSubspace(summoduletypes.ModuleName),
	)
	...
	app.OddnumKeeper = *oddnummodulekeeper.NewKeeper(
		...
		app.GetSubspace(oddnummoduletypes.ModuleName),
	)
	oddnumModule := oddnummodule.NewAppModule(appCodec, app.OddnumKeeper, app.AccountKeeper, app.BankKeeper)

	app.NewcheckersKeeper = *newcheckersmodulekeeper.NewKeeper(
		appCodec,
		keys[newcheckersmoduletypes.StoreKey],
		keys[newcheckersmoduletypes.MemStoreKey],
		app.GetSubspace(newcheckersmoduletypes.ModuleName),
	)
	...
	app.mm.SetOrderBeginBlockers(
		...
		newcheckersmoduletypes.ModuleName,
...
func initParamsKeeper(appCodec codec.BinaryCodec, legacyAmino *codec.LegacyAmino, key, tkey sdk.StoreKey) paramskeeper.Keeper {
	...
	paramsKeeper.Subspace(newcheckersmoduletypes.ModuleName)
